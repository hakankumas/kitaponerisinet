...
<head>
  ...
  <title>kitaponerisi.net | Kullanıcı Hesabı Oluştur</title>
          ...
          <div class="col-lg-12 entries justify-content-center" style="padding-left: 25%; padding-right: 25%;">
            <div class="blog-comments">
              <div class="reply-form">
                <h2 class="text-center">Yeni Bir Kullanıcı Hesabı Oluştur</h2>
                <hr class="m-5">
                <form action="user/process.php" method="POST">
                  <div class="row">
                    <div class="col-md-12 form-group">
                      <input type="text" name="user_username" class="form-control" placeholder="Kullanıcı Adı" required autofocus>
                    </div>
                    <div class="col-md-12 form-group">
                      <input type="password" name="user_password" class="form-control" placeholder="Şifre" required>
                    </div>
                  </div>
                  <button type="submit" name="create_user" class="btn btn-primary" style="display: flex; margin:auto;">Hesap Oluştur</button>
                </form>
              </div>
