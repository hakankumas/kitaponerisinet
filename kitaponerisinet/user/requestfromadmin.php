...
<html lang="en">
<head>
  <title>kitaponerisi.net | Kullanıcı | Talep Bildir</title>
    ...
    <div class="row">
      <div class="col-12 rounded pb-3 pt-3 mb-5 mt-3" style="background-color:aliceblue; padding:25%;">
        <form action="process.php" method="POST" class="form-group bg-light p-3 mt-4">
          ...
          <h1 class="mb-5 text-center"><b>Talep Bildir</b></h1>

          <div class="mb-4">
            <label for="usertoadmin_message_title" class="form-label">Başlık</label>
            <input type="text" class="form-control" name="usertoadmin_message_title" id="usertoadmin_message_title" required autofocus>
          </div>

          <div class="mb-4">
            <label for="usertoadmin_message_content" class="form-label">Mesaj</label>
            <textarea class="form-control" name="usertoadmin_message_content" id="usertoadmin_message_content" rows="4" required></textarea>
          </div>

          <div class="mb-3 mt-5">
            <button type="submit" class="btn btn-lg btn-success btn-icon-split mt-3" name="add_usertoadmin_message" id="update_user_password" style="display: flex; margin:auto;">
              <span class="icon text-white-100"><i class="fas fa-check"></i></span>
              <span class="text ps-2">Gönder</span>
            </button>
          </div>
        </form>
      </div>
