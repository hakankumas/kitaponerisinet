...
<head>
  ...
  <title>kitaponerisi.net | Kullanıcı Giriş Ekranı</title>
          ...
          <div class="col-lg-12 entries justify-content-center" style="padding-left: 25%; padding-right: 25%;">
            <div class="blog-comments">
              <div class="reply-form">
                <h2 class="text-center">Kullanıcı Giriş Ekranı</h2>
                <hr class="m-5">
                <form action="tools/process.php" method="POST">
                  ...
                  <button type="submit" name="user_login" class="btn btn-primary" style="display: flex; margin:auto;">Giriş Yap</button>
                </form>
              </div>
